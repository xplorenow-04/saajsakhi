            ...
            <div className="lg:col-span-3">
              <form onSubmit={handlePlaceOrder}>
                ...
                <button
                  type="submit"
                  disabled={placing}
                  className="w-full mt-6 flex items-center justify-center gap-2 bg-accent hover:bg-accent/90 disabled:bg-surface-600 disabled:text-text-muted disabled:cursor-not-allowed text-white font-semibold py-4 rounded-xl transition-all duration-300 shadow-lg shadow-accent/20 hover:shadow-accent/30 active:scale-[0.98]"
                >
                  {placing ? (
