        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6 lg:space-y-8">
              {/* Category */}
              {product.category && (
                <span className="inline-block text-xs font-semibold text-accent uppercase tracking-[0.2em]">
                    ...
                    {sizes.map((s) => {
                      ...
                      return (
                        <button
                          ...
                          disabled={outOfStock}
                          className={`relative min-w-[48px] px-4 py-3 text-sm font-medium rounded-xl border transition-all ${isSelected
                              ? "bg-accent border-accent text-white shadow-lg shadow-accent/20"
                              : outOfStock
                                ? "bg-surface-800/50 border-surface-600 text-text-dim/40 line-through cursor-not-allowed"
                                : "bg-surface-800 border-surface-600 text-text-secondary hover:border-accent/50 hover:text-accent"
                            }`}
                        >
                          {sizeVal}
                          {isSelected && (
              ...
              <div className="space-y-3">
                <div className="flex items-stretch gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-accent hover:bg-accent/90 disabled:bg-surface-600 disabled:text-text-muted disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-accent/20 hover:shadow-accent/30 active:scale-[0.98]"
                  >
                    <ShoppingBag size={18} />
                ...
                <button
                  ...
                  disabled={!inStock}
                  className="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20ba59] disabled:bg-surface-600 disabled:text-text-muted disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-xl transition-all duration-300 shadow-lg shadow-green-500/20 hover:shadow-green-500/30 active:scale-[0.98]"
                >
              ...
              <div className="grid grid-cols-3 gap-3 pt-2">
                {[
                  ...
                  return (
                    <div
                      key={badge.text}
                      className="flex items-center gap-2 text-xs text-text-muted bg-surface-800/50 rounded-lg px-3 py-2.5 border border-surface-700/50"
                    >
                      <BadgeIcon size={14} className="text-accent shrink-0" />
