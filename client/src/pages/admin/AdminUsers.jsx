                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          className="p-1.5 text-text-muted hover:text-accent hover:bg-surface-600 rounded-lg transition-colors disabled:opacity-50"
                          title={user.isDisabled ? "Enable User" : "Disable User"}
                        >
                          {togglingId === user._id ? (
                            <span className="w-[15px] h-[15px] block border-2 border-accent border-t-transparent rounded-full animate-spin" />
                          ) : user.isDisabled ? (
                            <ToggleRight size={15} />
                          ) : (
                            <ToggleLeft size={15} />
