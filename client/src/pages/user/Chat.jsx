                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div style={{
                            width: 36, height: 36,
                            borderRadius: 11,
                            background: 'linear-gradient(135deg, rgba(212,175,55,0.2), rgba(223,184,108,0.1))',
                            border: '1px solid rgba(212,175,55,0.3)',
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            boxShadow: '0 0 16px rgba(212,175,55,0.15)',
                        }}>
                            <Sparkles size={16} color="#DFB86C" />
                        </div>
                        <div>
                ...
                <div style={{ flex: 1, padding: '20px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                                    <div className="skeleton-pulse" style={{ width: 80, height: 10, borderRadius: 5, background: 'rgba(212,175,55,0.15)' }} />
                                </div>
                                {[1, 0.7, 0.85].map((w, i) => (
                            ...
                            <div style={{
                                ...
                                {[0.9, 0.75, 0.8, 0.65].map((w, i) => (
                                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                        <div className="skeleton-pulse" style={{ width: 6, height: 6, borderRadius: '50%', background: 'rgba(212,175,55,0.2)', flexShrink: 0 }} />
                    ...
                    {!isLoading && summary && (
                        <>
                            ...
                            <div style={{
                                borderRadius: 14,
                                background: 'linear-gradient(135deg, rgba(212,175,55,0.08), rgba(223,184,108,0.03))',
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginBottom: 10 }}>
                                    <Sparkles size={12} color="#DFB86C" />
                                    <span style={{ fontSize: 11, fontWeight: 700, color: '#DFB86C', textTransform: 'uppercase', letterSpacing: '0.07em' }}>
                                        Overview
                                    </span>
                                </div>
                                    ...
                                    {summary.keyPoints.map((point, i) => (
                                        <div key={i} style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                                            <div style={{
                                                ...
                                                background: 'linear-gradient(135deg, rgba(212,175,55,0.15), rgba(223,184,108,0.1))',
                                                border: '1px solid rgba(212,175,55,0.25)',
                                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                fontSize: 9, fontWeight: 700, color: '#DFB86C',
                                                marginTop: 1,
                                            }}>
                                                {i + 1}
                                            </div>
        ...
        return (
            ...
            >
                <div className="flex items-center gap-2.5 flex-1 min-w-0 rounded-[11px] px-3 py-2"
                    ...
                    <Reply size={12} color="#DFB86C" style={{ transform: 'scaleX(-1)', flexShrink: 0 }} />
                    <div className="flex flex-col min-w-0 flex-1">
                        <span className="text-[11px] font-semibold leading-none mb-[3px]" style={{ color: '#DFB86C' }}>
                            {senderLabel}
                        </span>
        ...
        <>
            <style>{`
                * { font-family: 'Sora', sans-serif; box-sizing: border-box; }
                ...
                .summarize-btn {
                    ...
                    background: linear-gradient(135deg, rgba(212,175,55,0.12), rgba(223,184,108,0.06));
                    border: 1px solid rgba(212,175,55,0.25);
                    color: #DFB86C; font-size: 12px; font-weight: 600;
                    cursor: pointer; transition: all 0.2s ease;
                    white-space: nowrap;
                }
                .summarize-btn:hover {
                    background: linear-gradient(135deg, rgba(212,175,55,0.2), rgba(223,184,108,0.12));
            ...
            <div className="flex h-[100dvh] bg-surface-900 text-text-primary overflow-hidden">
                ...
                <div className="relative flex flex-col flex-1 h-full bg-surface-800 overflow-hidden md:flex">
                    ...
                    {/* Ambient orbs */}
                    <div className="absolute -top-24 -right-24 w-[400px] h-[400px] rounded-full pointer-events-none z-0 bg-gold-500/5 blur-[80px]" />
                    <div className="absolute -bottom-20 left-[10%] w-[300px] h-[300px] rounded-full pointer-events-none z-0 bg-gold-400/5 blur-[80px]" />
                    ...
                    {context.currentChatUser ? (
                            ...
                            {isMedia ? (
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        {!isAtBottom && (
                                            <button
                                                ...
                                                className="fixed z-20 bottom-24 right-8 w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-r from-gold-200 to-gold-500 border-none cursor-pointer transition-all duration-150 hover:-translate-y-0.5 shadow-[0_4px_16px_rgba(212,175,55,0.35)]"
                                            >
                                                <ArrowDownCircleIcon size={18} className="text-neutral-950" />
                                            </button>
                                        )}
                                    ...
                                    {chatUsersInfo[currentChatId]?.newMessages > 0 && (
                                        <div className="fade-in-up absolute bottom-[88px] left-1/2 -translate-x-1/2 z-20 flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold text-gold-400 border border-gold-500/30 bg-gold-500/10 backdrop-blur-md">
                                            <MoveDown size={13} />
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-3 h-20 px-5">
                                            ...
                                            <button
                                                onClick={handleSend}
                                                className="flex-shrink-0 flex items-center justify-center w-11 h-11 rounded-xl border-none cursor-pointer bg-gradient-to-r from-gold-200 via-gold-500 to-gold-600 shadow-[0_4px_14px_rgba(212,175,55,0.35)] transition-all duration-150 hover:-translate-y-0.5 hover:scale-[1.04] active:scale-95"
                                            >
                                                <Send size={18} className="text-neutral-950" />
                                            </button>
                                        </div>
                                    </footer>
                                </>
                        ...
                        <div className="relative z-[1] flex flex-col items-center justify-center w-full h-full gap-4">
                            <div
                                className="float-icon flex items-center justify-center w-[72px] h-[72px] rounded-[24px] border border-gold-500/20 shadow-[0_0_30px_rgba(212,175,55,0.1)] bg-gold-500/5"
                            >
                                <MessageCircle size={32} className="text-gold-400" />
                            </div>
