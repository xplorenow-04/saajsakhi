    ...
    const NavIconBtn = ({ icon: Icon, panel, badge, tooltip }) => {
        ...
        return (
            <button
                ...
                style={{
                    background: active
                        ? 'linear-gradient(135deg,rgba(212,175,55,0.2),rgba(223,184,108,0.1))'
                        : 'transparent',
                    border: active ? '1px solid rgba(212,175,55,0.3)' : '1px solid transparent',
                    boxShadow: active ? '0 0 16px rgba(212,175,55,0.15)' : 'none'
                }}
            >
                <Icon size={18} color={active ? '#DFB86C' : '#4a4e6a'} strokeWidth={2} />
                {badge > 0 && (
                    <span className="absolute -top-1 -right-1 flex items-center justify-center w-[18px] h-[18px] rounded-full text-[9px] font-bold text-neutral-950"
                        style={{ background: 'linear-gradient(135deg,#FFFDF0,#D4AF37)' }}>
                        {badge > 9 ? '9+' : badge}
                    </span>
                )}
                {/* Tooltip */}
                <span className="absolute left-full ml-2.5 px-2 py-1 text-[11px] font-medium text-gold-400 bg-surface-950 border border-gold-500/20 rounded-[8px] whitespace-nowrap pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150 z-50 shadow-[0_4px_12px_rgba(0,0,0,0.6)]">
                    {tooltip}
                </span>
            </button>
        )
                ...
                <div className="relative flex flex-col flex-1 h-full bg-surface-800 overflow-hidden hidden md:flex">
                    ...
                    {context.currentChatUser ? (
                                            ...
                                            >
                                                ...
                                                {!isAtBottom && (
                                                     <button
                                                        ...
                                                        className="fixed z-20 bottom-24 right-8 w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-r from-gold-200 to-gold-500 border-none cursor-pointer transition-all duration-150 hover:-translate-y-0.5 shadow-[0_4px_16px_rgba(212,175,55,0.4)]"
                                                    >
                        ...
                        <div className="relative z-[1] flex flex-col items-center justify-center w-full h-full gap-4">
                            <div
                                className="float-icon flex items-center justify-center w-[72px] h-[72px] rounded-2xl border border-gold-500/20 bg-gold-500/5 shadow-[0_0_30px_rgba(212,175,55,0.1)]"
                            >
