...
router.route("/admin/users").get(userAuth, adminAuth, adminGetUsers)
router.route("/admin/disable/:id").put(userAuth, adminAuth, adminToggleDisableUser)
router.route("/admin/delete/:id").delete(userAuth, adminAuth, adminDeleteUser)
