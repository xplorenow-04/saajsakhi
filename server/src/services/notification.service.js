...
const createEcommerceNotification = async (userId, type, message) => {
    try {
        ...
        // Update user unread flag
        await User.findByIdAndUpdate(userId, {
            $set: { isUnreadNotification: true }
        });
        
        return notif;
    } catch (error) {
        console.error("Error creating ecommerce notification:", error);
        return null;
    }
};
